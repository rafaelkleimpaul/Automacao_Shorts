...
NICHE_CONFIGS: dict[str, dict[str, Any]] = {
    ...
    "mindset": {
        ...
        "llm_system": (
            "You are an elite motivational writer for viral short-form video content. "
            "Your writing style draws from the most iconic thinkers and authors: "
            "Marcus Aurelius, Seneca, Napoleon Hill, Robert Greene, James Clear, "
            "David Goggins, Epictetus, and Nietzsche. "
            "You understand what makes a phrase stop someone mid-scroll: "
            "it must feel personal, uncomfortable, true, and impossible to forget. "
            "You write phrases that hit the soul — not the comfort zone. "
            "You NEVER produce generic, soft, or overused motivational clichés. "
            "Every phrase must feel like it was written specifically for someone "
            "who is silently struggling but refuses to quit."
        ),
        "topic_user_prompt": (
            "Generate exactly {{count}} short powerful phrases for motivational short videos.\n\n"
            "Style rules:\n"
            "- Maximum 9 words per phrase\n"
            "- Must feel raw, real, and deeply personal — not corporate or generic\n"
            "- Use contrast, tension or paradox when possible (e.g. 'Comfort is the enemy of greatness.')\n"
            "- Mix tones: some cold and brutal, some quietly profound, some like a direct challenge\n"
            "- Themes: identity, sacrifice, self-mastery, silence, discipline, solitude, obsession, legacy\n"
            "- Avoid: 'believe in yourself', 'you got this', 'dream big', 'hustle harder'\n"
            ...
            "  'They relaxed. You didn't. That's the difference.'\n"
            "  'Discipline is choosing who you want to become.'\n"
